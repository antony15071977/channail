...
$ag_url = 'https://agwd.ru/cms/demo';  // Адрес Ag Booking CMS.
...
?>
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru"><head><meta http-equiv="Content-Type" content="text/html;  charset=utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" /><title><?php echo $ag_page_title;  ?></title><meta name="copyright" content="©  <?php echo $ag_page_title;  ?>"><meta name="title" content="<?php echo $ag_page_title;  ?>" /><meta name="description" content="<?php echo $ag_page_description;  ?>" /><meta property="og:title" content="<?php echo $ag_page_description;  ?>" /><meta property="og:description" content="<?php echo $ag_page_description;  ?>" /><meta property="og:type" content="website" /><link rel="stylesheet" href="<?php echo $ag_url;  ?>/css/icons/fontello.css" /><link rel="stylesheet" href="<?php echo $ag_url;  ?>/css/icons/fontello.php" /><link rel="stylesheet" href="<?php echo $ag_url;  ?>/css/icons/animation.css" /><link rel="stylesheet" href="<?php echo $ag_url;  ?>/css/main.css" /><link rel="stylesheet" href="<?php echo $ag_url;  ?>/css/colorbox.css" /><link rel="stylesheet" href="<?php echo $ag_url;  ?>/themes/Default/css/style.css" /><style>body{ padding:18px 18px 18px 18px;  background:#fff }h2.ag_title{ font-size:20px; font-weight:normal; margin:0 0 18px 0;}.ag_main_mobile .ag_submit, .ag_main_mobile .ag_button{ padding:18px 0; width:100%; text-align:center }button,input,a,span,div,li,i{ -webkit-tap-highlight-color:rgba(0,0,0,0); -webkit-tap-highlight-color:transparent }</style><script src="<?php echo $ag_url;  ?>/js/jquery-2.1.1.js"></script><script src="<?php echo $ag_url;  ?>/js/jquery-ui.min.js"></script><script src="<?php echo $ag_url;  ?>/js/jquery.scrollTo.min.js"></script><script src="<?php echo $ag_url;  ?>/js/jquery.colorbox-min.js"></script><script>function ag_window_size(){ 
...
if (ag_window_size().windoww<ag_window_size().minw) { $("#ag_main").addClass("ag_main_mobile"); 
...
function ag_select_service(e){ $("#ag_title_servie").text($(e).find("option:selected").text()); window.location="";  }
