...
function ag_multi_inp($type, $name, $id, $value, $options, $upload, $user, $class, $users, $access) {
...
echo '<input type="text" name="' .$name. '['.$n.'][0]" value="' .$laddress. '" placeholder="'.$ag_lng['inp_name'].'" class="' .$class. '" id="input_' .$id.'_address_'.$n. '" onfocus="ag_active(\'label_' .$id.'_address_'.$n. '\')" onblur="ag_out(\'label_' .$id.'_address_'.$n. '\')" />';
echo '<span class="element_tools">
...
echo '<input type="text" name="' .$name. '['.$n.'][1]" value="' .$ltext. '" placeholder="'.$ag_lng['inp_value'].'" class="' .$class. '" id="input_' .$id.'_text_'.$n. '" onfocus="ag_active(\'label_' .$id.'_text_'.$n. '\')" onblur="ag_out(\'label_' .$id.'_text_'.$n. '\')" />';
...
echo '<input type="text" name="' .$name. '[0][0]" value="' .$laddress. '" placeholder="'.$ag_lng['inp_name'].'" class="' .$class. '" id="input_' .$id. '_address_0" onfocus="ag_active(\'label_' .$id. '_address_0\')" onblur="ag_out(\'label_' .$id. '_address_0\')" />';
echo '<span class="element_tools">
<span class="ag_icon_element"><i class="icon-pencil-7"></i></span>
</span>';
echo '</label>';
...
echo '<input type="text" name="' .$name. '[0][1]" value="' .$ltext. '" placeholder="'.$ag_lng['inp_value'].'" class="' .$class. '" id="input_' .$id. '_text_0" onfocus="ag_active(\'label_' .$id. '_text_0\')" onblur="ag_out(\'label_' .$id. '_text_0\')" />';
...
$ag_append .= '<input type=\"text\" name=\"' .$name. '[" + ' .$id. '_num + "][0]\" value=\"\" placeholder=\"'.$ag_lng['inp_name'].'\" class=\"' .$class. '\" id=\"input_' .$id. '_address_" + ' .$id. '_num + "\" onfocus=\"ag_active(\'label_' .$id.'_address_" + ' .$id. '_num + "\')\" onblur=\"ag_out(\'label_' .$id.'_address_" + ' .$id. '_num + "\')\" />';
$ag_append .= '<span class=\"element_tools\"><span class=\"ag_icon_element\"><i class=\"icon-pencil-7\"></i></span></span>';
$ag_append .= '</label>';
$ag_append .= '</div>';
$ag_append .= '</div>';
...
$ag_append .= '<input type=\"text\" name=\"' .$name. '[" + ' .$id. '_num + "][1]\" value=\"\" placeholder=\"'.$ag_lng['inp_value'].'\" class=\"' .$class. '\" id=\"input_' .$id. '_text" + ' .$id. '_num + "\" onfocus=\"ag_active(\'label_' .$id.'_text_" + ' .$id. '_num + "\')\" onblur=\"ag_out(\'label_' .$id.'_text_" + ' .$id. '_num + "\')\" />';
